...
import { MapTile, TileMap } from "./MapTile";
...
export class Stage extends THREE.Scene{
  ...
  get camera(){ return this.mCamera };
  ...
  constructor( w=800, h=600){
    ...
    // dirLight.setRotationFromEuler(new THREE.Euler(
    ...
    //spotLight.target.position.set( 48*7.5, 0,  48*7.5 );
  ...
  async onPointerUp( evt:PointerEvent){
    ...
    const intersects = this.mRaycaster.intersectObjects( this.mTileMap.children, false );
